  ...
  return (
    <main className="flex flex-col items-center justify-center py-20">
      <div className="flex flex-col gap-6 items-center justify-center">
        <div className="flex flex-col gap-7 items-center justify-center px-2 w-full">
          ...
          >
            ...
            <Button size={isSmallScreen ? 'default' : 'sm'}>
              Join Waitlist
            </Button>
          </div>
        </div>

        <div className="relative max-w-[280px] sm:max-w-xl mx-auto w-full h-[13em] sm:h-[24em] lg:h-[26.25em] lg:max-w-4xl border mt-10">
          <div className="absolute h-full w-[1.25em] -left-5 rotate-180 overflow-hidden border-r bg-transparent bg-[linear-gradient(-45deg,rgba(0,0,0,0.01)_40%,rgba(0,0,0,0.15)_40%,rgba(0,0,0,0.15)_45%,rgba(0,0,0,0.01)_45%,rgba(0,0,0,0.01)_90%,rgba(0,0,0,0.15)_90%,rgba(0,0,0,0.01)_95%)] bg-[size:15px_15px]" />
          <div className="absolute h-full w-[1.25em] -right-5 overflow-hidden border-r bg-transparent bg-[linear-gradient(-45deg,rgba(0,0,0,0.01)_40%,rgba(0,0,0,0.15)_40%,rgba(0,0,0,0.15)_45%,rgba(0,0,0,0.01)_45%,rgba(0,0,0,0.01)_90%,rgba(0,0,0,0.15)_90%,rgba(0,0,0,0.01)_95%)] bg-[size:15px_15px]" />
